...
class Proxy
  ...
  def initialize(target_object)
    ...
    @parent = object.class
    object.define_singleton_method(:messages) do
      @new_methods ||= []
    end
    # ADD MORE CODE HERE
  end
  ...
  def number_of_times_called(this_meth)
    messages.select{|meth| meth == this_meth}.count
  end

  def method_missing(method_name, *args, &block)
    object.messages << method_name unless method_name == :messages
